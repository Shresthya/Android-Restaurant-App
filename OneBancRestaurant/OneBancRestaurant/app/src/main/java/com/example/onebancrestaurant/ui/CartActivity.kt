...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        totalText.text = "Net Total: ₹%.2f".format(netTotal)
        cgstText.text = "CGST (2.5%%): ₹%.2f".format(tax)
        sgstText.text = "SGST (2.5%%): ₹%.2f".format(tax)
        grandTotalText.text = "Grand Total: ₹%.2f".format(grandTotal)
